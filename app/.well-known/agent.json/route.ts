...
import { SITE_NAME, SITE_DESCRIPTION, BASE_URL as DEFAULT_BASE_URL, ORG_NAME, ORG_URL, CONTACT_EMAIL, SUPPORT_EMAIL, SECURITY_EMAIL, GITHUB_REPO } from '@/lib/site-config'
